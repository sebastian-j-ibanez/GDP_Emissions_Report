...
data = data[data['country'] == 'the United States']
...
plt.title('US Emissions - Polynomial Predicted Model (3rd Degree)')
...
plt.title('US GDP - Polynomial Predicted Model (3rd Degree)')
plt.legend(['Actual', 'Predicted'])
plt.xlabel('Year')
plt.ylabel('GDP')
plt.show()